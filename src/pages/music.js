    ...
    <>
      ...
      <section className="relative z-10 min-h-screen pt-32 pb-24 px-6 sm:px-8 flex items-center">
        <div className="max-w-3xl mx-auto w-full">
          ...
          >
            Side <span className="italic text-accent">channel.</span>
          </h1>
          <p
            className="reveal text-lg text-muted mb-12 leading-relaxed max-w-xl"
          ...
          <div
            className="reveal border border-edge bg-surface p-6 sm:p-8"
          ...
          >
            ...
            <p className="font-mono text-[11px] tracking-[0.1em] uppercase text-muted mt-4 text-center">
